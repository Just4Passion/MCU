/****************************************************************
 * MBEDTLS_NO_PLATFORM_ENTROPY  // 屏蔽平台熵源
 * MBEDTLS_AES_FEWER_TABLES     // 减少AES表大小
 * MBEDTLS_USER_CONFIG_FILE="mbedtls_config.h"  // 使用自定义配置
 * 
 * Disable
 *  #define MBEDTLS_SSL_PROTO_DTLS        // 禁用DTLS
 *  #define MBEDTLS_SSL_SRV_C             // 禁用服务器功能
 *  #define MBEDTLS_KEY_EXCHANGE_PSK_ENABLED  // 禁用PSK密钥交换
 * 
 ...
 * ****************************************************************/
  ...
  *********************************************************/
/*****************************
Module-Dependency: md.c - pem.c; ssl_tls.c
*****************************/
//#define MBEDTLS_MD5_C
/*****************************
Module-Dependency: sha1.c; md.c; psa_crypto_hash.c
*****************************/
...
Module-Dependency: 
    entropy.c; 
    md.c;
    ssl_tls.c; ssl*_client.c; ssl*_server.c; ssl_cookie.c
******************************/
...
/*****************************
Module-Dependency: ripemd160.c
******************************/
//#define MBEDTLS_RIPEMD160_C
/*****************************
Module-Dependency: md.c
    constant_time.c
    ecdsa.c
    ecjpake.c
    hkdf.c
    hmac_drbg.c
    pk.c; pkcs5.c; pkcs12.c; 
    psa_crypto_ecp.c; psa_crypto_rsa.c
    rsa.c
    ssl_cookie.c;ssl_msg.cssl_tls.c
    x509.c;x509_crt.c;x509write_crt.c;x509write_csr.c
******************************/
#define MBEDTLS_MD_C            //管理所有散列算法

/*****************************
Module-Dependency: hmac_drbg.c
******************************/
#define MBEDTLS_HMAC_DRBG_C

/*****************************
Module-Dependency: poly1305.c
    chachapoly.c
******************************/
